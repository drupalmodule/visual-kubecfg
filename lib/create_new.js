function kubecfg(startParams) {
        ...
        switch (s.Operation) {
                ...
                case 'resize':
                        for (var r in rControllers){
                            if ( rControllers[r].Id === s.Id ){
                                ...
                                cli.error(jsonfile);
                                k8update(restOptions, "v1beta1", s.Type, s.Id, jsonfile);
                                break;
                             }
                ...
                case 'create':
                        ...
                        k8create(restOptions, "v1beta1", s.Type, jsonfile);
                ...
                case 'delete':
                        // TODO not implement yet 
                        k8delete(restOptions, "v1beta1", s.Type, s.Id);
                        break;
