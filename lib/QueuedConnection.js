...
var QueuedConnection = (function(_super){
	...
	QueuedConnection.prototype.DoConnection = function() {
                //cli.error(util.inspect(this._options,true,null,true));
                //cli.error(util.inspect(this._requestHandler,true,null,true));
                //cli.error(util.inspect(this._responseHandler,true,null,true));
