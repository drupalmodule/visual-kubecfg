...
var QueuedConnection = (function(_super){
	...
	QueuedConnection.prototype.DoConnection = function() {
                //cli.debug(util.inspect(this._options,true,null,true));
                //cli.debug(util.inspect(this._requestHandler,true,null,true));
                //cli.debug(util.inspect(this._responseHandler,true,null,true));
